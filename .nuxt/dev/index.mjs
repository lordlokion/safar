...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/devalue/index.js';
import { renderSSRHead } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/lordlokion/Documents/travell/safar/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/lordlokion/Documents/travell/safar/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/lordlokion/Documents/travell/safar/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/lordlokion/Documents/travell/safar/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/lordlokion/Documents/travell/safar","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/lordlokion/Documents/travell/safar/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/lordlokion/Documents/travell/safar/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/lordlokion/Documents/travell/safar/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/lordlokion/Documents/travell/safar/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _xswPy1moJk = (function(nitro) {
...
const _lazy_1yAubM = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_1yAubM, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_1yAubM, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"hid":"description","name":"description","content":"This is my portfolio website."},{"hid":"og:title","property":"og:title","content":"Lord Lokion"},{"hid":"og:description","property":"og:description","content":"This is my portfolio website."},{"hid":"og:site_name","property":"og:site_name","content":"Lord Lokion"},{"hid":"og:type","property":"og:type","content":"website"},{"hid":"og:image","property":"og:image","content":""},{"hid":"twitter:card","name":"twitter:card","content":"summary_large_image"},{"hid":"twitter:image","name":"twitter:image","content":""}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1","title":"Lord Lokion"};
...
const getClientManifest = () => import('file:///home/lordlokion/Documents/travell/safar/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
